...
class Analyzer(object):
    ...
    def get_calibrations(self, num_bins) -> typing.Dict:
        ...
        return self.compute_calibration(
            np.array(labels), np.array(preds), np.array(confidence), num_bins
        )
    ...
    @staticmethod
    def reliability_diagram_subplot(
        ax,
        bin_data,
        draw_ece=True,
        ...
        if draw_ece:
            ...
            ax.text(
                ...
                fontsize=font_sizes.get("ece", 24),
            )
    ...
    @staticmethod
    def confidence_histogram_subplot(
        ax,
        bin_data,
        draw_averages=True,
